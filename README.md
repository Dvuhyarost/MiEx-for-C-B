...
MiEx распространяется как отдельный JAR-файл, который содержит всё необходимое. Для получения дополнительной информации о том, как использовать MiEx, пожалуйста, посетите [wiki!](https://github.com/BramStoutProductions/MiEx/wiki)
